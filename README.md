...
This Repository is to Maintain Study Materials for Devops
...
```
cd existing_repo
git remote add origin https://gitlab.com/pknviki95/Devops_study.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/pknviki95/Devops_study/-/settings/integrations)
